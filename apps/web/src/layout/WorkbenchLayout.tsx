...
const menuItems: MenuProps["items"] = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "/atcoder/maintenance", icon: <Code2 size={17} />, label: "题库维护" }
    ]
  }
];
    ...
    <Layout className="workbenchShell">
      <Sider className="workbenchSider" width={248}>
        <div className="brandBlock">
          ...
          <div>
            <Typography.Text className="brandEyebrow">Practice Lab</Typography.Text>
        ...
        <div className="siderFootnote">
          <Space direction="vertical" size={4}>
            ...
            <Typography.Text type="secondary">统一题库、证据、维护和 IDE 链路。</Typography.Text>
          </Space>
        </div>
      </Sider>
